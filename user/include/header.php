                ...
                <?php if (is_login()) {
                 ...
                 ?>
                  ...
                  <a href="<?= base_url('user/profile.php'); ?>" class="nav-link dropdown-toggle">
                    <span><img src="../image/<?= $info['cus_avatar']; ?>" alt="" style="width: 30px;  height: 30px; border-radius: 50%;" class="acc_img_header"></span>
                    <span class="acc_name_header">
                      <?= $info['cus_name'];?>
                    </span>
                  </a>
                  <div class="dropdown-menu">
                    <a href="<?= base_url('user/profile.php'); ?>" class="dropdown-item">Tài khoản của tôi</a>
                    <a href="<?= base_url('user/purchase.php'); ?>" class="dropdown-item">Quản lý đơn hàng</a>
