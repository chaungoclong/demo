...
<div class="main_content bg-white row m-0 pt-4">
    ...
    <div class="form-row">
      <div class="form-group col-6">
       ...
       <div class="previewImage">
         <img src="../../image/<?= $product['pro_img']; ?>" alt="" class="w-25">
       </div>
       <script>
  ...
  <div class="form-group">
    ...
    <div class="oldLibrary d-flex mt-3 mb-3">
...
<?php else: ?>
  <h1 class="text-center text-danger mt-5">KHÔNG TÌM THẤY SẢN PHẨM</h1>
<?php endif ?>
   </div>
</div>
</div>
...
<script>
 $(function() {
  ...
  $(document).on('click', '.btn_remove_img_lib', function() {
    ...
    let removeImg = sendAJax( "process_product.php", "post", "json", data);

    $('.oldLibrary').html(removeImg.result);

    if(removeImg.status == "success") {
      alert("ĐÃ XÓA MỘT ẢNH");
    } else {
